...
import { b as en, g as tn } from "./index-Bkg4_ECi.js";
import { _ as rn } from "./__vite-browser-external-D7Ct-6yo.js";
var ut = { exports: {} };
const tr = en(rn);
var rr;
function nn() {
  return rr || (rr = 1, (function(he, un) {
    var ce = void 0, at = function(lt) {
      return ce || (ce = new Promise(function(nr, ir) {
        var W = typeof lt < "u" ? lt : {}, ft = W.onAbort;
        W.onAbort = function(e) {
          ir(new Error(e)), ft && ft(e);
        }, W.postRun = W.postRun || [], W.postRun.push(function() {
          nr(W);
        }), he = void 0;
        var o;
        o || (o = typeof W < "u" ? W : {});
        var or = typeof window == "object", Oe = typeof WorkerGlobalScope < "u", me = typeof process == "object" && typeof process.versions == "object" && typeof process.versions.node == "string" && process.type != "renderer";
        o.onRuntimeInitialized = function() {
            ...
            switch (typeof l) {
              ...
              case "object":
                if (l === null) Zt(s);
                  ...
                  var h = xe(l, Se);
                  Zr(s, h, l.length, -1), Re(h);
                } else Le(s, "Wrong API use : tried to return a value of an unknown type (" + l + ").", -1);
                break;
              default:
                Zt(s);
            }
          ...
          function t(s, l) {
            for (var h = [], p = 0; p < s; p += 1) {
              ...
              if (v === 1 || v === 2) d = Xr(d);
                ...
                v = d, d = Cr(v), v = Vr(v);
                for (var T = new Uint8Array(d), O = 0; O < d; O += 1) T[O] = N[v + O];
                d = T;
              } else d = null;
              h.push(d);
            }
          ...
          function n(s, l) {
            if (this.db = l, l = oe(s) + 1, this.eb = it(l), this.eb === null) throw Error("Unable to allocate memory for the SQL string");
          ...
          function i(s) {
            if (this.filename = "dbfile_" + (4294967295 * Math.random() >>> 0), s != null) {
              ...
              if (h && (h = typeof h == "string" ? h : He(h), p = l ? Be(h + "/" + l) : h), l = At(true, true), p = vr(p, l), s) {
                if (typeof s == "string") {
                  h = Array(s.length);
                  for (var d = 0, v = s.length; d < v; ++d) h[d] = s.charCodeAt(d);
                  s = h;
                }
                Ae(p, l | 146), h = te(p, 577), It(h, s, 0, s.length, 0), Ke(h), Ae(p, l);
              }
            }
            this.handleError(m(this.filename, u)), this.db = z(u, "i32"), Jt(this.db), this.fb = {}, this.Sa = {};
          }
          var u = C(4), a = o.cwrap, m = a("sqlite3_open", "number", ["string", "number"]), _ = a("sqlite3_close_v2", "number", ["number"]), b = a("sqlite3_exec", "number", ["number", "string", "number", "number", "number"]), A = a("sqlite3_changes", "number", ["number"]), x = a("sqlite3_prepare_v2", "number", ["number", "string", "number", "number", "number"]), Ht = a("sqlite3_sql", "string", ["number"]), Mr = a("sqlite3_normalized_sql", "string", ["number"]), Vt = a("sqlite3_prepare_v2", "number", ["number", "number", "number", "number", "number"]), Sr = a("sqlite3_bind_text", "number", ["number", "number", "number", "number", "number"]), Xt = a("sqlite3_bind_blob", "number", ["number", "number", "number", "number", "number"]), xr = a("sqlite3_bind_double", "number", ["number", "number", "number"]), Rr = a("sqlite3_bind_int", "number", ["number", "number", "number"]), Lr = a("sqlite3_bind_parameter_index", "number", ["number", "string"]), Or = a("sqlite3_step", "number", ["number"]), Pr = a("sqlite3_errmsg", "string", ["number"]), Tr = a("sqlite3_column_count", "number", ["number"]), Ur = a("sqlite3_data_count", "number", ["number"]), Dr = a("sqlite3_column_double", "number", ["number", "number"]), Yt = a("sqlite3_column_text", "string", ["number", "number"]), Wr = a("sqlite3_column_blob", "number", ["number", "number"]), jr = a("sqlite3_column_bytes", "number", ["number", "number"]), zr = a("sqlite3_column_type", "number", ["number", "number"]), Fr = a("sqlite3_column_name", "string", ["number", "number"]), Ir = a("sqlite3_reset", "number", ["number"]), Qr = a("sqlite3_clear_bindings", "number", ["number"]), Br = a("sqlite3_finalize", "number", ["number"]), Gt = a("sqlite3_create_function_v2", "number", "number string number number number number number number number".split(" ")), $r = a("sqlite3_value_type", "number", ["number"]), Cr = a("sqlite3_value_bytes", "number", ["number"]), Hr = a("sqlite3_value_text", "string", ["number"]), Vr = a("sqlite3_value_blob", "number", ["number"]), Xr = a("sqlite3_value_double", "number", ["number"]), Yr = a("sqlite3_result_double", "", ["number", "number"]), Zt = a("sqlite3_result_null", "", ["number"]), Gr = a("sqlite3_result_text", "", ["number", "string", "number", "number"]), Zr = a("sqlite3_result_blob", "", ["number", "number", "number", "number"]), Kr = a("sqlite3_result_int", "", ["number", "number"]), Le = a("sqlite3_result_error", "", ["number", "string", "number"]), Kt = a("sqlite3_aggregate_context", "number", ["number", "number"]), Jt = a("RegisterExtensionFunctions", "number", ["number"]), er = a("sqlite3_update_hook", "number", ["number", "number", "number"]);
          r.prototype.bind = function(s) {
            ...
            if (s == null && (s = this.Oa, this.Oa += 1), s = Yt(this.Qa, s), typeof BigInt != "function") throw Error("BigInt is not supported");
            return BigInt(s);
          }, r.prototype.Hb = function(s) {
            return s == null && (s = this.Oa, this.Oa += 1), Yt(this.Qa, s);
            ...
            l == null && (l = this.Oa, this.Oa += 1), s = gt(s);
            var h = xe(s, Se);
            this.lb.push(h), this.db.handleError(Sr(this.Qa, l, h, s.length - 1, 0));
          }, r.prototype.Bb = function(s, l) {
            l == null && (l = this.Oa, this.Oa += 1);
            var h = xe(s, Se);
            this.lb.push(h), this.db.handleError(Xt(this.Qa, l, h, s.length, 0));
          }, r.prototype.rb = function(s, l) {
            l == null && (l = this.Oa, this.Oa += 1), this.db.handleError((s === (s | 0) ? Rr : xr)(this.Qa, l, s));
          }, r.prototype.Eb = function(s) {
            s == null && (s = this.Oa, this.Oa += 1), Xt(this.Qa, s, 0, 0, 0);
            ...
            for (var s; (s = this.lb.pop()) !== void 0; ) Re(s);
            ...
            ie(u), ie(l);
            try {
              this.db.handleError(Vt(this.db.db, this.kb, -1, u, l)), this.kb = z(l, "i32");
              var h = z(u, "i32");
              return h === 0 ? (this.mb(), { done: true }) : (this.Za = new r(h, this.db), this.db.fb[h] = this.Za, { value: this.Za, done: false });
            } catch (p) {
              throw this.pb = Qe(this.kb), this.mb(), p;
            } finally {
              le(s);
            }
          }, n.prototype.mb = function() {
            Re(this.eb), this.eb = null;
          }, n.prototype.getRemainingSQL = function() {
            return this.pb !== null ? this.pb : Qe(this.kb);
            ...
            try {
              var v = rt(s), T = C(4);
              for (s = []; z(v, "i8") !== 0; ) {
                ie(u), ie(T), this.handleError(Vt(this.db, v, -1, u, T));
                var O = z(u, "i32");
                if (v = z(T, "i32"), O !== 0) {
                  var R = null;
                  for (d = new r(O, this), l != null && d.bind(l); d.step(); ) R === null && (R = { columns: d.getColumnNames(), values: [] }, s.push(R)), R.values.push(d.get(null, h));
                  d.free();
                }
              }
              return s;
            ...
            if (ie(u), this.handleError(x(this.db, s, -1, u, 0)), s = z(u, "i32"), s === 0) throw "Nothing to prepare";
            var h = new r(s, this);
            ...
            Object.values(this.fb).forEach(function(l) {
              l.free();
            }), Object.values(this.Sa).forEach($), this.Sa = {}, this.handleError(_(this.db));
            var s = gr(this.filename);
            return this.handleError(m(this.filename, u)), this.db = z(u, "i32"), Jt(this.db), s;
          }, i.prototype.close = function() {
            this.db !== null && (Object.values(this.fb).forEach(function(s) {
              s.free();
            }), Object.values(this.Sa).forEach($), this.Sa = {}, this.Ya && ($(this.Ya), this.Ya = void 0), this.handleError(_(this.db)), Dt("/" + this.filename), this.db = null);
            ...
            Object.prototype.hasOwnProperty.call(this.Sa, s) && ($(this.Sa[s]), delete this.Sa[s]);
            var h = ae(function(p, d, v) {
              d = t(d, v);
              try {
            ...
            return this.Sa[s] = h, this.handleError(Gt(this.db, s, l.length, 1, 0, h, 0, 0, 0)), this;
          }, i.prototype.create_aggregate = function(s, l) {
            var h = l.init || function() {
              return null;
            }, p = l.finalize || function(R) {
              return R;
            }, d = l.step;
            if (!d) throw "An aggregate function must have a step function in " + s;
            var v = {};
            Object.hasOwnProperty.call(this.Sa, s) && ($(this.Sa[s]), delete this.Sa[s]), l = s + "__finalize", Object.hasOwnProperty.call(this.Sa, l) && ($(this.Sa[l]), delete this.Sa[l]);
            var T = ae(function(R, U, st) {
              var G = Kt(R, 1);
              Object.hasOwnProperty.call(v, G) || (v[G] = h()), U = t(U, st), U = [v[G]].concat(U);
              try {
                v[G] = d.apply(null, U);
              } catch (Jr) {
                delete v[G], Le(R, Jr, -1);
              }
            }, "viii"), O = ae(function(R) {
              var U = Kt(R, 1);
              try {
                var st = p(v[U]);
              } catch (G) {
            ...
            return this.Sa[s] = T, this.Sa[l] = O, this.handleError(Gt(this.db, s, d.length - 1, 1, 0, 0, T, O, 0)), this;
          }, i.prototype.updateHook = function(s) {
            this.Ya && (er(this.db, 0, 0), $(this.Ya), this.Ya = void 0), s && (this.Ya = ae(function(l, h, p, d, v) {
              switch (h) {
                case 18:
                  l = "insert";
                  break;
              ...
              s(l, p, d, Number(v));
            }, "viiiij"), er(this.db, this.Ya, 0));
          }, o.Database = i;
        };
        var ht = { ...o }, Pe = "./this.program", pe = (e, t) => {
          throw t;
        }, j = "", Te, de;
        if (me) {
          var Ue = tr;
          j = __dirname + "/", de = (e) => (e = ye(e) ? new URL(e) : e, Ue.readFileSync(e)), Te = async (e) => (e = ye(e) ? new URL(e) : e, Ue.readFileSync(e, void 0)), !o.thisProgram && 1 < process.argv.length && (Pe = process.argv[1].replace(/\\/g, "/")), process.argv.slice(2), he.exports = o, pe = (e, t) => {
            throw process.exitCode = e, t;
          };
        } else (or || Oe) && (Oe ? j = self.location.href : typeof document < "u" && document.currentScript && (j = document.currentScript.src), j = j.startsWith("blob:") ? "" : j.slice(0, j.replace(/[?#].*/, "").lastIndexOf("/") + 1), Oe && (de = (e) => {
          var t = new XMLHttpRequest();
          return t.open("GET", e, false), t.responseType = "arraybuffer", t.send(null), new Uint8Array(t.response);
        }), Te = async (e) => {
          if (ye(e)) return new Promise((r, n) => {
        ...
        var ct = o.print || console.log.bind(console), Z = o.printErr || console.error.bind(console);
        Object.assign(o, ht), ht = null, o.thisProgram && (Pe = o.thisProgram);
        var we = o.wasmBinary, be, _e = false, De, N, y, re, g, k, We, P, je, ye = (e) => e.startsWith("file://");
        function mt() {
          var e = be.buffer;
          o.HEAP8 = N = new Int8Array(e), o.HEAP16 = re = new Int16Array(e), o.HEAPU8 = y = new Uint8Array(e), o.HEAPU16 = new Uint16Array(e), o.HEAP32 = g = new Int32Array(e), o.HEAPU32 = k = new Uint32Array(e), o.HEAPF32 = We = new Float32Array(e), o.HEAPF64 = je = new Float64Array(e), o.HEAP64 = P = new BigInt64Array(e), o.HEAPU64 = new BigUint64Array(e);
        }
        var H = 0, ne = null;
        function K(e) {
          var _a;
          throw (_a = o.onAbort) == null ? void 0 : _a.call(o, e), e = "Aborted(" + e + ")", Z(e), _e = true, new WebAssembly.RuntimeError(e + ". Build with -sASSERTIONS for more info.");
        }
        var ze;
        async function sr(e) {
          if (!we) try {
          ...
          if (e == ze && we) e = new Uint8Array(we);
          else if (de) e = de(e);
        ...
        async function ar(e) {
          var t = ze;
          if (!we && typeof WebAssembly.instantiateStreaming == "function" && !ye(t) && !me) try {
            var r = fetch(t, { credentials: "same-origin" });
            return await WebAssembly.instantiateStreaming(r, e);
          } catch (n) {
            Z(`wasm streaming compile failed: ${n}`), Z("falling back to ArrayBuffer instantiation");
          }
          return ur(t, e);
        }
        class Fe {
        ...
        function ie(e) {
          ...
          switch (t.endsWith("*") && (t = "*"), t) {
            ...
            case "*":
              ...
              break;
            default:
              K(`invalid type for setValue: ${t}`);
          }
        }
        var bt = typeof TextDecoder < "u" ? new TextDecoder() : void 0, E = (e, t = 0, r = NaN) => {
          var n = t + r;
          for (r = t; e[r] && !(r >= n); ) ++r;
          if (16 < r - t && e.buffer && bt) return bt.decode(e.subarray(t, r));
          for (n = ""; t < r; ) {
            var i = e[t++];
            if (i & 128) {
              var u = e[t++] & 63;
          ...
          return (e = _t(e.split("/").filter((n) => !!n), !t).join("/")) || t || (e = "."), e && r && (e += "/"), (t ? "/" : "") + e;
        }, yt = (e) => {
          ...
          return t = _t(t.split("/").filter((i) => !!i), !r).join("/"), (r ? "/" : "") + t || ".";
        }, $e = [], oe = (e) => {
        ...
        function Et(e, t) {
          qt[e] = { input: [], output: [], cb: t }, Ge(e, cr);
        }
        var cr = { open(e) {
...
`));
          ...
          t === null || t === 10 ? (ct(E(e.output)), e.output = []) : t != 0 && e.output.push(t);
        }, fsync(e) {
          var _a;
          0 < ((_a = e.output) == null ? void 0 : _a.length) && (ct(E(e.output)), e.output = []);
        }, Tb() {
        ...
        }, Ce = null, kt = {}, J = [], dr = 1, Q = null, Nt = false, Mt = true, St = {}, f = class {
          constructor(e) {
          ...
          constructor(e, t, r, n) {
            ...
            e || (e = this), this.parent = e, this.Xa = e.Xa, this.id = dr++, this.name = t, this.mode = r, this.rdev = n, this.atime = this.mtime = this.ctime = Date.now();
          }
          get read() {
        ...
        function L(e, t = {}) {
          ...
          e: for (; 40 > r; r++) {
            ...
            for (var n = Ce, i = "/", u = 0; u < e.length; u++) {
              var a = u === e.length - 1;
              if (a && t.parent) break;
              if (e[u] !== ".") if (e[u] === "..") i = yt(i), n = n.parent;
              else {
                i = Be(i + "/" + e[u]);
                try {
                  n = V(n, e[u]);
                ...
                if (!n.ab || a && !t.nb || (n = n.ab.root), (n.mode & 61440) === 40960 && (!a || t.$a)) {
                  ...
                  n = n.La.readlink(n), n.charAt(0) === "/" || (n = yt(i) + "/" + n), e = n + "/" + e.slice(u + 1).join("/");
                  continue e;
                }
              }
            }
        ...
        function V(e, t) {
          var r = S(e.mode) ? (r = ee(e, "x")) ? r : e.La.lookup ? 0 : 2 : 54;
          if (r) throw new f(r);
          for (r = Q[Ve(e.id, t)]; r; r = r.bb) {
            var n = r.name;
        ...
        function xt(e, t, r, n) {
          return e = new br(e, t, r, n), t = Ve(e.parent.id, e.name), e.bb = Q[t], Q[t] = e;
        }
        function S(e) {
        ...
        function M(e) {
          if (e = J[e], !e) throw new f(8);
          return e;
        }
        function Pt(e, t = -1) {
          if (e = Object.assign(new wr(), e), t == -1) e: {
            for (t = 0; 4096 >= t; t++) if (!J[t]) break e;
            throw new f(33);
          }
          return e.fd = t, J[t] = e;
        }
        function _r(e, t = -1) {
          var _a, _b;
          return e = Pt(e, t), (_b = (_a = e.Ma) == null ? void 0 : _a.Rb) == null ? void 0 : _b.call(_a, e), e;
        }
        function Ye(e, t, r) {
          var n = e == null ? void 0 : e.Ma.Ua;
          e = n ? e : t, n ?? (n = t.La.Ua), ge(n), n(e, r);
        }
        var yr = { open(e) {
          var _a, _b;
          e.Ma = kt[e.node.rdev].Ma, (_b = (_a = e.Ma).open) == null ? void 0 : _b.call(_a, e);
        }, Va() {
          throw new f(70);
        } };
        function Ge(e, t) {
        ...
        function Tt(e, t) {
          var r = t === "/";
          if (r && Ce) throw new f(10);
          if (!r && t) {
            var n = L(t, { nb: false });
            if (t = n.path, n = n.node, n.ab) throw new f(10);
            if (!S(n.mode)) throw new f(54);
          }
          t = { type: e, Wb: {}, zb: t, Ib: [] }, e = e.Xa(t), e.Xa = t, t.root = e, r ? Ce = e : n && (n.ab = t, n.Xa && n.Xa.Ib.push(t));
        }
        function qe(e, t, r) {
          var n = L(e, { parent: true }).node;
          if (e = ve(e), !e) throw new f(28);
        ...
        function Ee(e, t, r) {
          typeof r > "u" && (r = t, t = 438), qe(e, t | 8192, r);
        }
        function Ze(e, t) {
          if (!hr(e)) throw new f(44);
          var r = L(t, { parent: true }).node;
          if (!r) throw new f(44);
          t = ve(t);
          var n = Lt(r, t);
          if (n) throw new f(n);
        ...
        function Ut(e) {
          var t = L(e, { parent: true }).node;
          e = ve(e);
          var r = V(t, e), n = Ot(t, e, true);
          if (n) throw new f(n);
        ...
        function Dt(e) {
          ...
          if (!t) throw new f(44);
          e = ve(e);
          var r = V(t, e), n = Ot(t, e, false);
          if (n) throw new f(n);
          if (!t.La.unlink) throw new f(63);
          if (r.ab) throw new f(10);
          t.La.unlink(t, e), Xe(r);
        }
        function se(e, t) {
          return e = L(e, { $a: !t }).node, ge(e.La.Ta)(e);
        }
        function Wt(e, t, r, n) {
          Ye(e, t, { mode: r & 4095 | t.mode & -4096, ctime: Date.now(), Fb: n });
        }
        function Ae(e, t) {
          e = typeof e == "string" ? L(e, { $a: true }).node : e, Wt(null, e, t);
        }
        function jt(e, t, r) {
        ...
        function te(e, t, r = 438) {
          ...
          if (r = t & 64 ? r & 4095 | 32768 : 0, typeof e == "object") n = e;
            ...
            var i = e.endsWith("/");
            e = L(e, { $a: !(t & 131072), Jb: true }), n = e.node, e = e.path;
          }
          var u = false;
          if (t & 64) if (n) {
            ...
            if (i) throw new f(31);
            n = qe(e, r | 511, 0), u = true;
          }
          if (!n) throw new f(44);
          if ((n.mode & 61440) === 8192 && (t &= -513), t & 65536 && !S(n.mode)) throw new f(54);
          if (!u && (i = n ? (n.mode & 61440) === 40960 ? 32 : S(n.mode) && (Rt(t) !== "r" || t & 576) ? 31 : ee(n, Rt(t)) : 44)) throw new f(i);
          return t & 512 && !u && (i = n, i = typeof i == "string" ? L(i, { $a: true }).node : i, jt(null, i, 0)), t &= -131713, i = Pt({ node: n, path: He(n), flags: t, seekable: true, position: 0, Ma: n.Ma, Lb: [], error: false }), i.Ma.open && i.Ma.open(i), u && Ae(n, r & 511), !o.logReadFiles || t & 1 || e in St || (St[e] = 1), i;
        }
        function Ke(e) {
        ...
        function It(e, t, r, n, i) {
          ...
          e.seekable && e.flags & 1024 && zt(e, 0, 2);
          var u = typeof i < "u";
          if (!u) i = e.position;
          else if (!e.seekable) throw new f(70);
        ...
        function gr(e) {
          ...
          return Ft(r, n, 0, e, 0), t = n, Ke(r), t;
        }
        function B(e, t, r) {
          e = Be("/dev/" + e);
          var n = At(!!t, !!r);
        ...
        var Ne = void 0, Me = () => {
          var e = g[+Ne >> 2];
          return Ne += 4, e;
        }, Je = 0, qr = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335], Er = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], ue = {}, Qt = (e) => {
          var _a;
          De = e, Ie || 0 < Je || ((_a = o.onExit) == null ? void 0 : _a.call(o, e), _e = true), pe(e, new Fe(e));
        }, Ar = (e) => {
          if (!_e) try {
            if (e(), !(Ie || 0 < Je)) try {
              De = e = De, Qt(e);
            } catch (t) {
              t instanceof Fe || t == "unwind" || pe(1, t);
            }
          } catch (t) {
            t instanceof Fe || t == "unwind" || pe(1, t);
          }
          ...
          if (!tt) {
            var e = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (typeof navigator == "object" && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", _: Pe || "./this.program" }, t;
            for (t in et) et[t] === void 0 ? delete e[t] : e[t] = et[t];
            var r = [];
          ...
          if (n) for (var m = 0; m < n.length; m++) {
            var _ = i[r[m]];
            _ ? (a === 0 && (a = fe()), u[m] = _(n[m])) : u[m] = n[m];
          }
          return r = e(...u), r = (function(b) {
            return a !== 0 && le(a), t === "string" ? b ? E(y, b) : "" : t === "boolean" ? !!b : b;
          })(r);
        }, Se = 0, xe = (e, t) => (t = t == 1 ? C(e.length) : it(e.length), e.subarray || e.slice || (e = new Uint8Array(e)), y.set(e, t), t), Y, nt = [], I, $ = (e) => {
          Y.delete(I.get(e)), I.set(e, null), nt.push(e);
        }, ae = (e, t) => {
          if (!Y) {
            Y = /* @__PURE__ */ new WeakMap();
            var r = I.length;
            if (Y) for (var n = 0; n < 0 + r; n++) {
              var i = I.get(n);
              i && Y.set(i, n);
            }
          }
          if (r = Y.get(e) || 0) return r;
          if (nt.length) r = nt.pop();
          else {
            try {
              I.grow(1);
            } catch (_) {
        ...
        Q = Array(4096), Tt(w, "/"), D("/tmp"), D("/home"), D("/home/web_user"), (function() {
          D("/dev"), Ge(259, { read: () => 0, write: (n, i, u, a) => a, Va: () => 0 }), Ee("/dev/null", 259), Et(1280, mr), Et(1536, pr), Ee("/dev/tty", 1280), Ee("/dev/tty1", 1536);
          var e = new Uint8Array(1024), t = 0, r = () => (t === 0 && (vt(e), t = e.byteLength), e[--t]);
          B("random", r), B("urandom", r), D("/dev/shm"), D("/dev/shm/tmp");
        })(), (function() {
          D("/proc");
          var e = D("/proc/self");
          D("/proc/self/fd"), Tt({ Xa() {
            var t = xt(e, "fd", 16895, 73);
            return t.Ma = { Va: w.Ma.Va }, t.La = { lookup(r, n) {
              r = +n;
              var i = M(r);
              return r = { parent: null, Xa: { zb: "fake" }, La: { readlink: () => i.path }, id: r + 1 }, r.parent = r;
            }, readdir() {
              return Array.from(J.entries()).filter(([, r]) => r).map(([r]) => r.toString());
            } }, t;
          } }, "/proc/self/fd");
        })(), w.vb = new f(44), w.vb.stack = "<generic error, no stack>";
        var Nr = { a: (e, t, r, n) => K(`Assertion failed: ${e ? E(y, e) : ""}, at: ` + [t ? t ? E(y, t) : "" : "unknown filename", r, n ? n ? E(y, n) : "" : "unknown function"]), i: function(e, t) {
          try {
            return e = e ? E(y, e) : "", Ae(e, t), 0;
          } catch (r) {
          ...
          try {
            if (t = t ? E(y, t) : "", t = X(e, t), r & -8) return -28;
            var n = L(t, { $a: true }).node;
          ...
          try {
            var t = M(e);
            return Ye(t, t.node, { timestamp: Date.now(), Fb: false }), 0;
          } catch (r) {
            if (typeof q > "u" || r.name !== "ErrnoError") throw r;
            return -r.Pa;
          }
          ...
          try {
            return e = e ? E(y, e) : "", ke(t, se(e, true));
          } catch (r) {
            if (typeof q > "u" || r.name !== "ErrnoError") throw r;
            return -r.Pa;
          }
          ...
          try {
            return t = t ? E(y, t) : "", t = X(e, t), D(t, r), 0;
          } catch (n) {
            if (typeof q > "u" || n.name !== "ErrnoError") throw n;
            return -n.Pa;
          }
          ...
          try {
            t = t ? E(y, t) : "";
            var i = n & 256;
            return t = X(e, t, n & 4096), ke(r, i ? se(t, true) : se(t));
          } catch (u) {
            if (typeof q > "u" || u.name !== "ErrnoError") throw u;
            return -u.Pa;
          }
          ...
          try {
            if (t = t ? E(y, t) : "", t = X(e, t), 0 >= n) return -28;
            var i = L(t).node;
            if (!i) throw new f(44);
            if (!i.La.readlink) throw new f(28);
            var u = i.La.readlink(i), a = Math.min(n, oe(u)), m = N[r + a];
          ...
          try {
            return t = t ? E(y, t) : "", t = X(e, t), r === 0 ? Dt(t) : r === 512 ? Ut(t) : K("Invalid flags passed to unlinkat"), 0;
          } catch (n) {
            if (typeof q > "u" || n.name !== "ErrnoError") throw n;
            return -n.Pa;
          }
          ...
          try {
            ...
            if ((u ?? i) !== null) {
              e = i;
              var _ = L(t, { $a: true }).node;
              ge(_.La.Ua)(_, { atime: e, mtime: u });
            }
            return 0;
          } catch (b) {
          ...
          var r = e.getFullYear();
          g[t + 28 >> 2] = (r % 4 !== 0 || r % 100 === 0 && r % 400 !== 0 ? Er : qr)[e.getMonth()] + e.getDate() - 1 | 0, g[t + 36 >> 2] = -(60 * e.getTimezoneOffset()), r = new Date(e.getFullYear(), 6, 1).getTimezoneOffset();
          ...
          try {
            ...
            var m = M(n);
            if ((t & 2) !== 0 && (r & 2) === 0 && (m.flags & 2097155) !== 2) throw new f(2);
            if ((m.flags & 2097155) === 1) throw new f(2);
            if (!m.Ma.ib) throw new f(43);
            if (!e) throw new f(28);
          ...
          if (ue[e] && (clearTimeout(ue[e].id), delete ue[e]), !t) return 0;
          var r = setTimeout(() => {
            delete ue[e], Ar(() => Ct(e, performance.now()));
          }, t);
          return ue[e] = { id: r, Xb: t }, 0;
        }, B: (e, t, r, n) => {
          ...
          for (var r = 1; 4 >= r; r *= 2) {
            ...
            e: {
              n = (Math.min(2147483648, 65536 * Math.ceil(Math.max(e, n) / 65536)) - be.buffer.byteLength + 65535) / 65536 | 0;
              try {
                be.grow(n), mt();
                var i = 1;
                break e;
          ...
          try {
            var r = M(e);
            return N[t] = r.tty ? 2 : S(r.mode) ? 3 : (r.mode & 61440) === 40960 ? 7 : 4, re[t + 2 >> 1] = 0, P[t + 8 >> 3] = BigInt(0), P[t + 16 >> 3] = BigInt(0), 0;
          } catch (n) {
            if (typeof q > "u" || n.name !== "ErrnoError") throw n;
            return n.Pa;
          }
          ...
          try {
            if (isNaN(t)) return 61;
            var i = M(e);
            return zt(i, t, r), P[n >> 3] = BigInt(i.position), i.ob && t === 0 && r === 0 && (i.ob = null), 0;
          } catch (u) {
            if (typeof q > "u" || u.name !== "ErrnoError") throw u;
            return u.Pa;
          }
        ...
        (async function() {
          ...
          function e(r) {
            var _a2;
            return c = r.exports, be = c.M, mt(), I = c.O, H--, (_a2 = o.monitorRunDependencies) == null ? void 0 : _a2.call(o, H), H == 0 && ne && (r = ne, ne = null, r()), c;
          }
          H++, (_a = o.monitorRunDependencies) == null ? void 0 : _a.call(o, H);
          var t = { a: Nr };
          return o.instantiateWasm ? new Promise((r) => {
            o.instantiateWasm(t, (n, i) => {
              e(n), r(n.exports);
            });
          }) : (ze ?? (ze = o.locateFile ? o.locateFile("sql-wasm.wasm", j) : j + "sql-wasm.wasm"), e((await ar(t)).instance));
        ...
        var it = o._malloc = (e) => (it = o._malloc = c.Da)(e), Re = o._free = (e) => (Re = o._free = c.Ea)(e);
        o._RegisterExtensionFunctions = (e) => (o._RegisterExtensionFunctions = c.Fa)(e);
        var $t = (e, t) => ($t = c.Ga)(e, t), Ct = (e, t) => (Ct = c.Ha)(e, t), le = (e) => (le = c.Ia)(e), C = (e) => (C = c.Ja)(e), fe = () => (fe = c.Ka)();
        o.stackSave = () => fe(), o.stackRestore = (e) => le(e), o.stackAlloc = (e) => C(e), o.cwrap = (e, t, r, n) => {
          var i = !r || r.every((u) => u === "number" || u === "boolean");
          return t !== "string" && i && !n ? o["_" + e] : (...u) => kr(e, t, r, u);
        }, o.addFunction = ae, o.removeFunction = $, o.UTF8ToString = Qe, o.ALLOC_NORMAL = Se, o.allocate = xe, o.allocateUTF8OnStack = rt;
        function ot() {
          function e() {
            var _a;
            if (o.calledRun = true, !_e) {
              if (!o.noFSInit && !Nt) {
                var t, r;
                Nt = true, n ?? (n = o.stdin), t ?? (t = o.stdout), r ?? (r = o.stderr), n ? B("stdin", n) : Ze("/dev/tty", "/dev/stdin"), t ? B("stdout", null, t) : Ze("/dev/tty", "/dev/stdout"), r ? B("stderr", null, r) : Ze("/dev/tty1", "/dev/stderr"), te("/dev/stdin", 0), te("/dev/stdout", 1), te("/dev/stderr", 1);
              }
              if (c.N(), Mt = false, (_a = o.onRuntimeInitialized) == null ? void 0 : _a.call(o), o.postRun) for (typeof o.postRun == "function" && (o.postRun = [o.postRun]); o.postRun.length; ) {
          ...
          if (0 < H) ne = ot;
            ...
            pt(wt), 0 < H ? ne = ot : o.setStatus ? (o.setStatus("Running..."), setTimeout(() => {
    ...
    he.exports = at, he.exports.default = at;
  })(ut)), ut.exports;
}
var on = nn();
const sn = tn(on), fn = Object.freeze(Object.defineProperty({ __proto__: null, default: sn }, Symbol.toStringTag, { value: "Module" }));
export {
  fn as s
};
